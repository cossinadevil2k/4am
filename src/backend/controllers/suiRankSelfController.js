import * as suiRankSelfService from "@/services/suiRankSelfService"
...
export const getAccount = async (req, res) => {
  ...
  const email = await suiRankSelfService.getAccountById(id)
  if (!email) {
...
export const deleteAccount = async (req, res) => {
  ...
  await suiRankSelfService.deleteAccount(ids)
