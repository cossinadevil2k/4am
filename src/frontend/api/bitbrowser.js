...
/**
 * @description 排列窗口以及调整窗口尺寸
 * @returns {Promise}
 */
function windowbounds(data) {
  return request({ method: "post", url: "/windowbounds", data });
}
...
function updateBrowserMemark(remark, browserIds) {
  return request({
    url: "/browser/remark/update",
    method: "post",
    data: { remark, browserIds },
  });
}
/**
